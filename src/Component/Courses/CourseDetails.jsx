...
const CourseDetails = () => {
  ...
  console.log("Dept:", course.department, "Title:", course.title);
    ...
    <div className="w-[90%] md:w-[80%] mx-auto py-10">
      ...
      <div className="flex flex-col md:flex-row gap-10">
        ...
        <div className="flex-1">
          ...
          <button className="mt-6 bg-blue-600 text-white py-2 px-6 rounded-lg text-lg hover:bg-blue-700 transition">
            🚀 Enroll Now
          </button>
        </div>
      </div>
