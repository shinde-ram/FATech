...
export default function Placement() {
  ...
  return (
    <div className="bg-gray-50 text-gray-800">
      {/* Hero Section */}
      <section className="text-center py-10 bg-gradient-to-r from-blue-100 to-purple-100 border shadow-xl  border-yellow-400">
        ...
        <button className="mt-6 px-6 py-2 bg-blue-600 text-white rounded-full hover:bg-blue-700 transition">View Success Stories</button>
      </section>



      <section className="py-20 mb-5 px-6 bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          {/* Left Side */}
          <div className="w-full md:w-1/2 flex flex-col justify-center items-center md:items-center text-center md:text-left space-y-6 relative z-10">
          ...
          <div className="w-full md:w-1/2 grid grid-cols-3 sm:grid-cols-3 gap-4 md:gap-6">
            {companies.map((company, i) => (
              ...
              >
                ...
                >
                  ...
                  {/* Back */}
                  <div
                    className="absolute inset-0 flex flex-col items-center justify-center bg-green-300 text-white text-sm font-semibold rounded-xl transform rotate-y-180"
                    style={{ backfaceVisibility: 'hidden' }}
                  >
                    <p className='text-5xl text-black'>{company.number} </p>
                    <p className='text-gray-600 mt-2'>Student Placed</p>
                  </div>
                </div>
              </div>
            ))}
      ...
      {/* CTA Section */}
      <section className="text-center py-10 bg-gradient-to-r from-blue-100 via-green-300 to-purple-100 text-black border border-yellow-400">
        ...
        <button className="px-8 py-2 bg-white text-blue-700 font-bold rounded-full hover:bg-purple-100 transition" onClick={()=>navigate("/courses")}>Explore Courses</button>
      </section>
    </div>
  );
}
