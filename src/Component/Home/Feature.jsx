            ...
            <div className="max-w-6xl mx-auto px-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                    {features.map((feature, index) => (
                        <div
                            key={index}
                            className="bg-white p-6 rounded-2xl shadow-lg border border-blue-100 hover:scale-105 transform transition duration-300"
                        >
                            <img src={feature.icon} alt="" className="w-10 h-10 text-black mb-4 mx-auto" />
                            {/* <CheckCircle className="w-10 h-10 text-blue-500 mb-4 mx-auto animate-pulse" /> */}
